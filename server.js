...
// 3. SECRET ADMIN ROUTE - Only accessible via this specific URL
app.get('/master-control-admin', (req, res) => {
    res.sendFile(path.join(__dirname, 'public/admin_portal.html'));
});

// 4. REGISTRATION LOGIC (Saves to Postgres)
...
app.listen(3000, () => console.log('Tesla Base Master Server Live'));
